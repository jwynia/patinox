...
impl From<LocalProviderError> for ProviderError {
    fn from(err: LocalProviderError) -> Self {
        match err {
            ...
            LocalProviderError::InvalidConfiguration(msg) => ProviderError::ConfigurationError(msg),
            LocalProviderError::NetworkError(err) => ProviderError::NetworkError(err.to_string()),
